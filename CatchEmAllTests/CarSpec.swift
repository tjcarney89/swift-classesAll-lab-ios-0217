...
class CarSpec: QuickSpec {
    override func spec() {
        describe("Car") {
            var car = Car(name: "Car", weight: 4079.0, maxSpeed: 130.0, transmission: "Auto", cylinders: 6, milesPerGallon: 24.0)

            beforeEach {
                car = Car(name: "Car", weight: 4079.0, maxSpeed: 130.0, transmission: "Auto", cylinders: 6, milesPerGallon: 24.0)
            }
            ...
            describe("initializer") {
                it("sets the properties") {
                    ...
                    expect(car.transmission).to(equal("Auto"))
